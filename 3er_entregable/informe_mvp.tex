...
\midrule
Usuario 1 \newline \textbf{José L. Mariño} \newline (Estudiante, 22 años) & Estudiante de pregrado. Usuario de BCP y Yape. Experimenta frustración debido a la falta de categorización automática y a la necesidad de realizar sumas manuales para transacciones pequeñas del día a día. & Representa al segmento estudiantil nativo digital que maneja múltiples microgastos diarios. Útil para validar la categorización inteligente y la reducción de fricción al ingresar transacciones. \\
\addlinespace
Usuario 2 \newline \textbf{Jean P. Pinedo} \newline (Freelancer, 22 años) & Trabajador independiente. Combina apps bancarias con un Excel manual. Frustrado por el excesivo tiempo que le consume registrar transacciones y por la lentitud de sincronización de saldos en apps de bancos. & Representa a trabajadores independientes que requieren optimizar su tiempo diario. Permite evaluar la fluidez, rapidez y centralización de balances financieros inmediatos. \\
\addlinespace
Usuario 3 \newline \textbf{Frank H. Bustillos} \newline (Estudiante, 23 años) & Estudiante de pregrado. Usuario de Yape. Frustrado por el control financiero fragmentado al no poder consolidar movimientos de múltiples tarjetas asociadas a otros bancos. & Clave para validar la necesidad de centralización de balances generales y probar la usabilidad de la interfaz conversacional para consolidar gastos diversos. \\
\addlinespace
Usuario 4 \newline \textbf{Augusto Arias} \newline (Estudiante, 22 años) & Estudiante de pregrado. No utiliza ninguna aplicación de control financiero por considerarlas sumamente lentas, tediosas y con formularios extensos y complejos. & Representa al perfil escéptico que rechaza las herramientas financieras tradicionales. Permite evaluar si el canal conversacional con IA elimina la barrera de adopción y simplifica el registro. \\
\addlinespace
Usuario 5 \newline \textbf{Jennifer Esquivel} \newline (Emprendedora, 38 años) & Emprendedora y comerciante. Usuaria de la app de Banco de la Nación. Frustrada por la interfaz obsoleta, lentitud de acceso y carencia de gráficos dinámicos para sus metas de ahorro. & Aporta la perspectiva de un perfil de mayor edad y orientación comercial que busca planificar metas específicas de ahorro y demanda una visualización interactiva y estimulante. \\
\bottomrule
\end{tabular}
\end{table}
...
Como soporte de las pruebas de validación realizadas, las respuestas individuales fueron consolidadas y registradas digitalmente. Se puede acceder al formulario de recolección y su estructura a través del siguiente enlace: \url{https://forms.cloud.microsoft/Pages/DesignPageV2.aspx?subpage=design&FormId=hRKP4i9nlEifTkQnO7tnaoRl3E9-FVFFs-pVqsR7SJlUQTRZNUM1V00yWVM4V1hDRzkyOUhNWEVLNy4u&Token=b98f512aea074831abc82839cd40fbc1}. Asimismo, el detalle individualizado de las respuestas cualitativas de cada evaluador se encuentra organizado en las bitácoras de respuestas del entregable.
...
\addlinespace
Usuario 3 & Al cometer un error de escritura en el chat (ej. poner un cero de más), no pudo corregirlo directamente en la ventana de conversación. & Implementar un botón de ``Deshacer'' (\textit{Undo}) o edición rápida en la misma tarjeta generada por el chat. \\
\addlinespace
Usuario 4 & Registrar manualmente o por chat cada gasto del negocio resulta demandante. Considera vital la sincronización bancaria automática. & Desarrollar integraciones con APIs de banca abierta (\textit{Open Banking}) para sincronización de saldos y movimientos bancarios. \\
\addlinespace
