...
% --- Configuración de Títulos estilo APA 7 con Numeración Romana Solicitada ---
...
\begin{itemize}
    \item \textbf{Uso y control actual:} El 64.3\% (9 de 14 usuarios) utiliza alguna aplicación móvil o banca digital para el seguimiento financiero (principalmente BCP, Yape y Banco de la Nación), mientras que el 35.7\% (5 de 14) no lleva ningún control global sobre sus movimientos.
    \item \textbf{Frustraciones críticas:} Entre los usuarios que utilizan plataformas tradicionales, el 44.4\% (4 de 9) reportó serias frustraciones relacionadas con la lentitud e ineficiencia del inicio de sesión y registro (``no es rápido y toma tiempo usarlo'', ``a veces demora más de lo usual'') o con caídas recurrentes del sistema.
    \item \textbf{Falta de centralización bancaria:} Un 22.2\% (2 de 9) destacó como principal frustración que las aplicaciones de banca móvil son cerradas y no registran de forma integrada los movimientos de otras entidades bancarias, obligándolos a realizar registros manuales separados.
...
\begin{figure}[H]
    \centering
    % Descomente y reemplace con su archivo de imagen correspondiente:
    % \includegraphics[width=0.85\textwidth]{src/assets/chat_screenshot.png}
    \framebox{\parbox{0.85\textwidth}{\centering\vspace{2.5cm} \textbf{[Captura 1: Módulo de Chat con IA]} \\ \vspace{0.3cm} Muestra la conversación interactiva donde el usuario ingresa un gasto en lenguaje natural y la IA devuelve la tarjeta confirmando el registro de la transacción. \vspace{2.5cm}}}
...
\begin{figure}[H]
    \centering
    % Descomente y reemplace con su archivo de imagen correspondiente:
    % \includegraphics[width=0.85\textwidth]{src/assets/movimientos_screenshot.png}
    \framebox{\parbox{0.85\textwidth}{\centering\vspace{2.5cm} \textbf{[Captura 2: Historial de Movimientos]} \\ \vspace{0.3cm} Muestra los paneles de Balance Neto, Ingresos, Gastos Totales, la tabla de transacciones históricas con filtros y el botón de creación manual. \vspace{2.5cm}}}
...
\begin{figure}[H]
    \centering
    % Descomente y reemplace con su archivo de imagen correspondiente:
    % \includegraphics[width=0.85\textwidth]{src/assets/limites_screenshot.png}
    \framebox{\parbox{0.85\textwidth}{\centering\vspace{2.5cm} \textbf{[Captura 3: Límites de Presupuesto]} \\ \vspace{0.3cm} Visualización de las barras de progreso por categoría (comida, transporte, etc.) y la línea de paso de presupuesto semanal. \vspace{2.5cm}}}
...
\begin{figure}[H]
    \centering
    % Descomente y reemplace con su archivo de imagen correspondiente:
    % \includegraphics[width=0.85\textwidth]{src/assets/ahorros_screenshot.png}
    \framebox{\parbox{0.85\textwidth}{\centering\vspace{2.5cm} \textbf{[Captura 4: Metas de Ahorro]} \\ \vspace{0.3cm} Visualiza la meta de Fondo de Emergencia, los botones del simulador de depósito rápido y los interruptores de notificaciones proactivas. \vspace{2.5cm}}}
...
\midrule
¿Usa actualmente alguna aplicación de seguimiento financiero? & El 80\% (4 de 5) utiliza herramientas móviles (BCP, Yape, BN o Excel). El 20\% (1 de 5) no cuenta con ninguna herramienta de control. \\
\addlinespace
¿El registro por chat e IA redujo la fatiga de la digitación manual? & El 100\% (5 de 5) indicó que la interfaz conversacional resolvió con éxito la fricción y pereza de la entrada tradicional de datos. \\
\addlinespace
...
\addlinespace
Utilidad de la visualización de presupuestos mediante semáforos & El 80\% (4 de 5) lo calificó como muy intuitivo para el control diario. El 20\% (1 de 5) sugirió presentarlo de otra forma. \\
\addlinespace
...
\addlinespace
Requerimientos de seguridad indispensables elegidos por los usuarios & El 60\% (3 de 5) prefiere autenticación biométrica (huella/Face ID) y el 40\% (2 de 5) prefiere verificación en dos pasos (2FA/SMS). \\
\addlinespace
...
Como soporte de las pruebas de validación realizadas, las respuestas individuales fueron consolidadas y registradas digitalmente. Se puede acceder al formulario de recolección y su estructura a través del siguiente enlace: \url{https://forms.microsoft.com/r/FinancIA-MVP-Evaluation-Placeholder}. Asimismo, el detalle individualizado de las respuestas cualitativas de cada evaluador se encuentra organizado en las bitácoras de respuestas del entregable.
...
\begin{tabular}{p{2.8cm}p{6.0cm}p{6.2cm}}
\toprule
\textbf{Early Adopter} & \textbf{Observación Realizada} & \textbf{Mejora Propuesta} \\
\midrule
Usuario 1 (Estudiante) & Observó que las categorías de presupuesto predefinidas son fijas. Desea agrupar gastos de fotocopias o libros en una categoría específica de ``Educación''. & Permitir la creación y edición de categorías de gasto personalizadas a través de comandos de chat o en la interfaz de Límites. \\
\addlinespace
Usuario 2 (Freelancer) & La interfaz de chat es rápida y cómoda, pero desearía un recordatorio semanal proactivo sobre el estado del presupuesto sin tener que ingresar a la app. & Diseñar un sistema de notificaciones externas de la IA (vía Telegram o correo electrónico) con resúmenes de rendimiento. \\
\addlinespace
Usuario 3 (Joven Prof.) & Al cometer un error de escritura en el chat (ej. poner un cero de más), no pudo corregirlo directamente en la ventana de conversación. & Implementar un botón de ``Deshacer'' (\textit{Undo}) o edición rápida en la misma tarjeta generada por el chat. \\
\addlinespace
Usuario 4 (Comerciante) & Registrar manualmente o por chat cada gasto del negocio resulta demandante. Considera vital la sincronización bancaria automática. & Desarrollar integraciones con APIs de banca abierta (\textit{Open Banking}) para sincronización de saldos y movimientos bancarios. \\
\addlinespace
Usuario 5 (Postgrado) & El simulador de ahorros incrementa el total acumulado, pero se pierde el registro cronológico de los depósitos ficticios ingresados. & Crear una pestaña de ``Historial de Depósitos'' en el módulo de Ahorros para listar montos y fechas de aportaciones a metas. \\
\bottomrule
\end{tabular}
\end{table}
