...
La forma en la que la pérdida del rastro de los gastos afecta a las personas con ingresos varía sustancialmente según el nivel y la estabilidad de sus recursos. El alcance del diagnóstico considera a los siguientes tres perfiles clave:
\begin{itemize}
    \item \textbf{Personas con Ingresos Bajos o Variables (Impacto Crítico / Alto):} Este grupo, compuesto por trabajadores independientes, autoempleados y estudiantes con ingresos temporales, enfrenta el reto de administrar flujos económicos irregulares. Debido a la falta de un registro continuo de transacciones, subestiman los gastos cotidianos y los imprevistos, lo que genera desbalances financieros recurrentes y sobreendeudamiento, elevando el impacto a un nivel crítico que pone en riesgo su estabilidad básica.
    \item \textbf{Personas con Ingresos Medios (Impacto Alto):} Representado principalmente por empleados asalariados y jóvenes profesionales con flujos constantes pero limitados. Su principal problema radica en la ``falsa liquidez'', un fenómeno donde la certeza de un ingreso mensual incentiva el gasto desmedido en entretenimiento y compras no esenciales. Al no rastrear estos egresos, se anula su capacidad de ahorro a mediano plazo, limitando su preparación para emergencias o metas mayores.
    \item \textbf{Personas con Ingresos Altos (Impacto Medio):} Este perfil agrupa a profesionales consolidados y personas con múltiples fuentes de ingresos estables. El impacto de la pérdida de control financiero se manifiesta en la dilución silenciosa del patrimonio. Los gastos hormiga repetitivos, suscripciones no utilizadas y la falta de optimización del capital disponible disminuyen su capacidad real de inversión, generando una constante sensación de pérdida de poder adquisitivo a pesar de percibir ingresos elevados.
\end{itemize}
...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item \textbf{amount} (REAL): Monto numérico del movimiento en soles peruanos.
    ...
    \begin{itemize}
        ...
        \item \textbf{target} (REAL): Monto objetivo a ahorrar en soles.
...
- Ahorros: Meta: "Fondo de Emergencia" (S/ 450,00 / S/ 5.000,00)
- Límites de Presupuesto: 
  * Comida fuera: Gastado S/ 49,50 de un límite de S/ 120,00
  * Transporte: Gastado S/ 18,75 de un límite de S/ 150,00
- Últimas Transacciones Registradas:
  * Gasto S/ 45,00 en Green Cafe (Comida fuera, Hoy)
\end{verbatim}
